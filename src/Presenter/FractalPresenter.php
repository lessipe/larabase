...
abstract class FractalPresenter implements PresenterInterface
{
    ...
    protected function parseIncludes()
    {
        ...
        $paramIncludes = config('larabase.fractal.params.include', 'include');
    ...
    {
        $serializer = config('larabase.fractal.serializer', 'League\\Fractal\\Serializer\\DataArraySerializer');
